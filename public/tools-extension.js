...
const weatherSymbols = [
    ...
    // ========== SURFACE FRONTS ==========
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#0066cc" stroke-width="2"/><polygon points="14,12 18,6 18,12" fill="#0066cc"/><polygon points="26,12 30,6 30,12" fill="#0066cc"/><polygon points="38,12 42,6 42,12" fill="#0066cc"/></svg>`, 
    ...
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#cc0000" stroke-width="2"/><path d="M 14,12 A 5,5 0 0,0 14,22" fill="#cc0000"/><path d="M 26,12 A 5,5 0 0,0 26,22" fill="#cc0000"/><path d="M 38,12 A 5,5 0 0,0 38,22" fill="#cc0000"/></svg>`, 
      code: 'WARM_FRONT', name: 'Warm Front', category: 'front',
      description: 'Warm air mass advancing and replacing cooler air', color: '#cc0000' },
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#666" stroke-width="2"/><polygon points="14,12 18,6 18,12" fill="#0066cc"/><path d="M 26,12 A 5,5 0 0,0 26,22" fill="#cc0000"/><polygon points="38,12 42,6 42,12" fill="#0066cc"/></svg>`, 
    ...
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#9933cc" stroke-width="2"/><polygon points="14,12 18,6 18,12" fill="#9933cc"/><path d="M 23,12 A 4,4 0 0,0 23,20" fill="#9933cc"/><polygon points="32,12 36,6 36,12" fill="#9933cc"/><path d="M 41,12 A 4,4 0 0,0 41,20" fill="#9933cc"/></svg>`, 
    ...
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><path d="M 2,12 Q 10,4 18,12 Q 26,20 34,12 Q 42,4 46,12" stroke="#ff6600" stroke-width="2" fill="none" stroke-dasharray="4,2"/></svg>`, 
    ...
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#ff9500" stroke-width="2"/><path d="M 10,12 A 4,4 0 0,1 10,20" stroke="#ff9500" stroke-width="1.5" fill="none"/><path d="M 18,12 A 4,4 0 0,1 18,20" stroke="#ff9500" stroke-width="1.5" fill="none"/><path d="M 26,12 A 4,4 0 0,1 26,20" stroke="#ff9500" stroke-width="1.5" fill="none"/><path d="M 34,12 A 4,4 0 0,1 34,20" stroke="#ff9500" stroke-width="1.5" fill="none"/><path d="M 42,12 A 4,4 0 0,1 42,20" stroke="#ff9500" stroke-width="1.5" fill="none"/></svg>`, 
    ...
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#0066cc" stroke-width="2" stroke-dasharray="6,3"/><polygon points="20,12 24,6 24,12" fill="#0066cc"/><polygon points="40,12 44,6 44,12" fill="#0066cc"/></svg>`, 
    ...
    { symbol: `<svg viewBox="0 0 48 24" width="40" height="20"><line x1="2" y1="12" x2="46" y2="12" stroke="#cc0000" stroke-width="2" stroke-dasharray="6,3"/><path d="M 26,12 A 5,5 0 0,0 26,22" fill="#cc0000"/></svg>`, 
